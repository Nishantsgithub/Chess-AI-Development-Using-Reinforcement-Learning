...
def main():
    ...
    parser.add_argument("--num_games", type=int, default=30000, help="Number of games to play")
    ...
    for game_num in range(25000, args.num_games + 1):  # Start from 1
        ...
        command = f"python /data/acp22np/ScalableML/Alpha-zero/playchess.py --model {model_path} --mode s --color w --rollouts 10 --threads 6 --verbose"
